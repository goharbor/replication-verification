...
Go Into Project
    ...
    \    ...  ELSE IF  ${has_image}=='none'  Retry Double Keywords When Error  Retry Element Click  xpath=//*[@id='project-results']//clr-dg-cell[contains(.,'${project}')]/a    Set Variable  'PASS'   DoAssert=${false}
