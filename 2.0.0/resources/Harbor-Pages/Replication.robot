...
Create A New Endpoint
    ...
    Run Keyword If  '${provider}' != 'aws-ecr' and '${provider}' != 'google-gcr'   Run keyword  Retry Text Input  xpath=${destination_url_xpath}  ${url}
...
Image Should Be Replicated To Project
    ...
    \    Sleep  ${period}
    \    Go Into Project    ${project}    has_image='none'
